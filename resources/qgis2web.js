...
map.getView().fit([-10014876.787328, 1604178.686900, -10001800.155702, 1612956.357156], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ÍNDICE DE HUMEDAD TOPOGRÁFICA DEPARTAMENTO DE JUTIAPA</h2>';
        return titleElement;
    })(),
